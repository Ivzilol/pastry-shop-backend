...
public class UserServiceImpl implements UserService {
    ...
    private static final String VERIFICATION_MAIL_URL = "https://sladkarnicata-na-mama.azurewebsites.net/register";

    private static final String FORGOTTEN_PASSWORD_URL = "https://sladkarnicata-na-mama.azurewebsites.net/forgotten-password/";
